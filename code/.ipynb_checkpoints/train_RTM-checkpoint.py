...
def get_args():
    ...
    parser.add_argument('--log_path', type=str, default='/home/zhan3275/data/log_rnn/BRS/train_log', help='path to save logging files and images')
    ...
    parser.add_argument('--model', type=str, default='BRS_RTM_GRU', help='type of model to construct')
