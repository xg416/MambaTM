...
def get_args():
    ...
    parser.add_argument('--train_path', type=str, default='/home/zhan3275/lab/data/TurbulenceData/static_new/train_static', help='path of training imgs')
    parser.add_argument('--train_path2', type=str, default='/home/zhan3275/lab/data/TurbulenceData/TMT_static/train_turb', help='path of training imgs')
    parser.add_argument('--val_path', type=str, default='/home/zhan3275/lab/data/TurbulenceData/static_new/test_static', help='path of validation imgs')  
    ...
    parser.add_argument('--run_name', type=str, default='SS3D', help='name of this running')
    parser.add_argument('--start_over', action='store_true')

    parser.add_argument('--model', type=str, default='MambaTM1', help='type of model to construct')
...
def main():
    ...
    train_dataset2 = DataLoaderTurbImage(rgb_dir=args.train_path2, num_frames=args.num_frames, total_frames=50, \
        im_size=args.patch_size, noise=0.0004, other_mod='blur',is_train=True, prefix='{:d}.jpg')
    
    train_loader = DataLoader(dataset=ConcatDataset([train_dataset, train_dataset2]), batch_size=args.batch_size, \
    ...
    val_loader = DataLoader(dataset=val_dataset, batch_size=args.batch_size*2, shuffle=True, num_workers=args.num_workers, drop_last=True, pin_memory=True)
