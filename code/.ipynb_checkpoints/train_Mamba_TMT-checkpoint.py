...
def get_args():
    ...
    parser.add_argument('--num_frames', type=int, default=32, help='number of frames for the model')
    parser.add_argument('--num_workers', type=int, default=16, help='number of workers in dataloader')
    parser.add_argument('--train_path', type=str, default='~/data/data_TMT/turb_syn_videos/train', help='path of training imgs')
    parser.add_argument('--val_path', type=str, default='~/data/data_TMT/turb_syn_videos/test', help='path of validation imgs') 
    parser.add_argument('--load', '-f', type=str, default=False, help='Load model from a .pth file')
    parser.add_argument('--log_path', type=str, default='~/Documents/train_log', help='path to save logging files and images')
    ...
    for epoch in range(1000000):
        for data in train_loader:
            ...
            if iter_count>start_iter and iter_count % args.print_period == 0:
                ...
                logging.info('Training: iters {:d}/{:d} -Time:{:.6f} -LR:{:.7f} -Loss {:8f} -PSNR: {:.2f} dB; SSIM: {:.4f}'
